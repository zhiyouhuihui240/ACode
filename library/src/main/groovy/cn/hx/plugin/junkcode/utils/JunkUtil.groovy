        ...
        switch (random.nextInt(5)) {
            case 0:
                ...
                methodBuilder.addStatement("long now = \$T.currentTimeMillis()", System.class)
                        ...
                        .addStatement((System.getProperty("FULL_NAME", fullName) != null ? "${str}AAAA(), ${Class.forName(System.getProperty("FULL_NAME"))}" : "${str}()")) // 方法名列表
...
//                        .addStatement("${str},${otherPackageNameList}.${otherClassNameList}")    // 方法名列表
            ...
            case 2:
                ...
                methodBuilder.beginControlFlow("try")
                        ...
                        .addStatement((System.getProperty("FULL_NAME", fullName) != null ? "${str}AAA(), ${Class.forName(System.getProperty("FULL_NAME"))}" : "${str}()")) // 方法名列表
//                        .addStatement("${str},${otherClassNameList}")    // 方法名列表
//                        .addStatement("${str},${otherPackageNameList}")    // 方法名列表
//                        .addStatement("${str},${otherPackageNameList}.${otherClassNameList}")    // 方法名列表
