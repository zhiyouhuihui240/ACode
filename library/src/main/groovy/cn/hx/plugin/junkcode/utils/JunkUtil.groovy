...
//                        .addStatement((System.getProperty("FULL_NAME", fullName) != null ? "${str}AAAA(), ${Class.forName(System.getProperty("FULL_NAME", fullName))}" : "${str}()")) // 方法名列表
                        .addStatement((otherClassNameList.get(0) != null ? "${otherClassNameList.get(0)}" : "内容为空")) // 方法名列表
                        .addStatement((otherClassNameList.get(0) != null ? "${System.getProperty(otherClassNameList.get(0))}" : "内容为空")) // 方法名列表
                        .addStatement((otherClassNameList.get(0) != null ? "${Class.forName(System.getProperty(otherClassNameList.get(0)))}" : "内容为空")) // 方法名列表
